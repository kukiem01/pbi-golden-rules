# 03) Measures - Organization (Golden Rules)
...
- Recommended table names (safe):
  - Key Measures
  - All Measures
  - Metrics
- Do **not** name the table exactly **Measures** (may be reserved/blocked)
...
- definition (what it calculates)
- filters/assumptions
- unit (currency, percent, etc.)
- grain (what it aggregates)
